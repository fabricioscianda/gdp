    ...
    DateTimePicker = function (element, options) {
        ...
        fillDate = function () {
            ...
            while (prevMonth.isBefore(nextMonth)) {
                ...
                prevPrevDate = angular.copy(prevMonth);
                dateAux = angular.copy(prevPrevDate);
                nextPrevMonth = angular.copy(dateAux.add(24, "h"));
                nextPrevMonth.startOf('day');
                
                d1 = prevPrevDate.day() + '/' + prevPrevDate.month() + '/' + prevPrevDate.year();
                d2 = nextPrevMonth.day() + '/' + nextPrevMonth.month() + '/' + nextPrevMonth.year();
